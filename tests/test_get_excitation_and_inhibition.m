...
function assert_x_ee(instance, use_fft)
...
function assert_x_ei(instance, use_fft)
    config = get_config(use_fft);
    [gx_padded, gy_padded, JW, interactions] = get_input(instance);
