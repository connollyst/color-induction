...
%   Detailed explanation goes here
    ...
    [e, f]                              = model.terms.interactions.scales.get_e_f(interactions.scale.distance);
    ...
    interactions.scale.filter           = model.terms.interactions.scales.filter(e, f, interactions.scale.distance);
    interactions.scale.filter_half_size = model.terms.interactions.scales.half_size_filter(interactions.scale.distance, interactions.scale.deltas, config);
