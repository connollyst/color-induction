function x_ei_scales_orients = x_ei(center_orient, gy, interactions, config)
% Excitatory-inhibitory term (no existia): x_ei
    x_ei_scales         = x_ei_scale_interactions(gy, interactions, config);
    x_ei_scales_orients = x_ei_orient_interactions(x_ei_scales, center_orient, interactions, config);
end

function x_ei_scales = x_ei_scale_interactions(gy, interactions, config)
