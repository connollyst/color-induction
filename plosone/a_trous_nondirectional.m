function [w c] = a_trous_nondirectional(image, wlev)
% Implementation of Mallat Discrete Wavelet Transform.
% outputs:
%   w: cell array of length wlev, containing nondirectional wavelet planes
