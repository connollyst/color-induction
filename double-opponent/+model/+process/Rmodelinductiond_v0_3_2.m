...
%   config:  the model configuration struct
    ...
    [all_J, all_W, all_J_fft, all_W_fft, M_norm_conv_fft, half_size_filter] = ...
        get_JW(n_scales, diameter, radius_sc, K, Delta, M, N, M_norm_conv, config);
...
function [all_J, all_W, all_J_fft, all_W_fft, M_norm_conv_fft, half_size_filter] = get_JW(n_scales, diameter, radius_sc, K, Delta, M, N, M_norm_conv, config)
    wave      = config.wave;
    zli       = config.zli;
